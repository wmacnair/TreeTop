	...
	switch run_switch			
		...
		case 8
			...
			input_struct 	= struct( ...
				...
				'used_markers', 		{{'CD10', 'CD117', 'CD179a', 'CD179b', 'CD19', 'CD20', 'CD24', 'CD34', 'CD38', 'CD45', 'CD72', 'CD79b', ...
										'HLADR', 'IgD', 'IgM-i', 'IgM-s', 'Kappa', 'Lambda'}}, ...
				'extra_markers', 		{{'CD127', 'CD22', 'CD235-61-66b', 'CD33-11c-16', 'CD40', 'CD49d', 'cPARP', 'Ki67', 'pAKT', 'Pax5', ...
										'pCreb', 'pErk12', 'pP38', 'pPLCg', 'pS6', 'pSrc', 'pSTAT5', 'pSyk', 'RAG1', 'TdT', 'wanderlust'}}, ...
				'filenames', 			{{'wanderlust sample G.fcs'}}, ...
				'file_annot', 			{{'sample G'}} ...
				);
			options_struct 	= struct( ...
				'metric_name', 			'angle', ...
		...
		case 9
			...
			fprintf('running treetop on healthy human bone marrow, scRNAseq data\n')
			input_struct 	= struct( ...
				'data_dir', 			fullfile(data_dir, 'bone marrow scRNAseq'), ...
				'output_dir', 			fullfile(output_dir, 'bone marrow scRNAseq'), ...
